...
This is a C and assembly project that tests memory bandwidth. There's a version in this directory for Linux that uses POSIX threads for multithreading.

To compile the linux version, do `make compile_arm` or `make compile_x86`, depending on the target architecture

# Example usage

Testing single threaded bandwidth: `MemoryBandwidth_arm` or `MemoryBandwidth_x86`
