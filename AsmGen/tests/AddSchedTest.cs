...
namespace AsmGen
{
    public class AddSchedTest : UarchTest
    {
        ...
        {
            string[] unrolledAdds = new string[4];
            unrolledAdds[0] = "  add t5, t5, s1";
            unrolledAdds[1] = "  add t4, t4, s1";
            unrolledAdds[2] = "  add t3, t3, s1";
            unrolledAdds[3] = "  add t2, t2, s1";

            string[] unrolledAdds1 = new string[4];
            unrolledAdds1[0] = "  add t5, t5, s2";
            unrolledAdds1[1] = "  add t4, t4, s2";
            unrolledAdds1[2] = "  add t3, t3, s2";
            unrolledAdds1[3] = "  add t2, t2, s2";
